 ...
 */
public class SysBusinessPermissionUuidGeneratorType extends AbstractUuidGenerator {

    public SysBusinessPermissionUuidGeneratorType(SysBusinessPermissionUuidGenerator config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
        super(idMember);
    }
