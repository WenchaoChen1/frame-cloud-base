package com.gstdev.cloud.service.identity.mapper.vo;

import com.gstdev.cloud.data.core.mapper.BaseVoMapper;
import com.gstdev.cloud.oauth2.data.jpa.entity.FrameAuthorization;
import com.gstdev.cloud.service.identity.base.Oauth2AuthorizationDto;
import com.gstdev.cloud.service.identity.base.Oauth2AuthorizationVo;
