...
public class ServiceContextHolderBuilder {
    ...
    private void toServiceContextHolder(EndpointProperties endpointProperties, ServiceContextHolder serviceContextHolder, boolean isDistributedArchitecture) {
        if (!isDistributedArchitecture) {
            ...
            serviceContextHolder.setIdentityServiceUri(issuerUri);
            serviceContextHolder.setSystemServiceUri(issuerUri);
            serviceContextHolder.setMessageServiceUri(issuerUri);
            serviceContextHolder.setOssServiceUri(issuerUri);
        } else {
            serviceContextHolder.setIdentityServiceName(endpointProperties.getIdentityServiceName());
            serviceContextHolder.setSystemServiceName(endpointProperties.getSystemServiceName());
            ...
            serviceContextHolder.setIdentityServiceUri(endpointProperties.getIdentityServiceUri());
            serviceContextHolder.setSystemServiceUri(endpointProperties.getSystemServiceUri());
