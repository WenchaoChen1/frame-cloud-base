...
// */
//public abstract class BaseController<E extends AbstractEntity, ID extends Serializable, S extends BaseService<E, ID>> extends BaseReadableRestController<E, ID,S> implements Controller<E, ID, S> {
//
////    @Override
////    public S getReadableService() {
