...
//    }
    public String getIdentityServiceUri() {
        return WellFormedUtils.serviceUri(identityServiceUri, getIdentityServiceName(), getGatewayServiceUri(), "identity");
    }
    ...
    public String getSystemServiceUri() {
        return WellFormedUtils.serviceUri(systemServiceUri, getSystemServiceName(), getGatewayServiceUri(), "system");
    }
