...
import com.gstdev.cloud.message.websocket.interceptor.WebSocketChannelInterceptor;
import com.gstdev.cloud.message.websocket.interceptor.WebSocketPrincipalHandshakeHandler;
import com.gstdev.cloud.message.websocket.properties.WebSocketProperties;
...
public class WebSocketMessageBrokerConfiguration extends AbstractSessionWebSocketMessageBrokerConfigurer<Session> {
    ...
    public void postConstruct() {
        log.debug("[GstDev Cloud] |- SDK [WebSocket Message Broker] Auto Configure.");
    }
