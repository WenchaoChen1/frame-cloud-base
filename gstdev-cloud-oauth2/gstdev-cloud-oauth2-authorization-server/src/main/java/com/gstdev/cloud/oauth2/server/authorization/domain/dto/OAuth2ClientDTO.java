package com.gstdev.cloud.oauth2.server.authorization.domain.dto;

import com.gstdev.cloud.oauth2.server.authorization.domain.*;
import lombok.Data;
...
public class OAuth2ClientDTO {
  ...
  public OAuth2RegisteredClient toClient() {
    ...
    oAuth2Client.setPostLogoutRedirectUris(postLogoutRedirectUris.stream().map(postLogoutRedirectUri -> {
      OAuth2PostLogoutRedirectUri oAuth2PostLogoutRedirectUri = new OAuth2PostLogoutRedirectUri();
      oAuth2PostLogoutRedirectUri.setClientId(clientId);
      oAuth2PostLogoutRedirectUri.setPostLogoutRedirectUri(postLogoutRedirectUri);
      return oAuth2PostLogoutRedirectUri;
    }).collect(Collectors.toSet()));
