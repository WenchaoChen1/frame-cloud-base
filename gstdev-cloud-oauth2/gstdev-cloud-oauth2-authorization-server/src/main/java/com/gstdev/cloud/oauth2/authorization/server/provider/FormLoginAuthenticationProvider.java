...
//        OAuth2FormLoginAuthenticationToken oAuth2FormLoginAuthenticationToken = (OAuth2FormLoginAuthenticationToken) authentication;
//
//        RegisteredClient registeredClient = RegisteredClient
//                .withId(UUID.randomUUID().toString())
//                .clientId("login id")
//                .clientName("login name")
////                .clientSecret("123456")
...
//
//
//        Authentication principal = getUsernamePasswordAuthentication(oAuth2FormLoginAuthenticationToken.getAdditionalParameters(), registeredClient.getId());
//
//
...
////                null, null);
////
//        oAuth2FormLoginAuthenticationToken.setAccessToken(accessToken);
