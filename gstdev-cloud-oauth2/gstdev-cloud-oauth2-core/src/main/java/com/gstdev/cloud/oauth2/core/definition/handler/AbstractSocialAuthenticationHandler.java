...
public abstract class AbstractSocialAuthenticationHandler implements SocialAuthenticationHandler {
     ...
     * @return 系统用户 {@link DefaultSecurityUser}
     * @throws UsernameAlreadyExistsException 用户名已经存在
     */
    public abstract DefaultSecurityUser register(SocialUserDetails socialUserDetails) throws UsernameAlreadyExistsException;
     ...
     *
     * @param defaultSecurityUser     系统用户信息 {@link DefaultSecurityUser}
     * @param socialUserDetails 社交登录过程中，第三方系统返回的新信息
     */
    public abstract void additionalRegisterOperation(DefaultSecurityUser defaultSecurityUser, SocialUserDetails socialUserDetails);
     ...
     * @return 系统用户 {@link DefaultSecurityUser}
     */
    public abstract DefaultSecurityUser signIn(SocialUserDetails socialUserDetails);
     ...
     */
    public abstract void additionalSignInOperation(DefaultSecurityUser defaultSecurityUser, SocialUserDetails newSocialUserDetails, SocialUserDetails oldSocialUserDetails);
     ...
     */
    @Override
    public DefaultSecurityUser authentication(String source, AccessPrincipal accessPrincipal) throws AuthenticationException {
        ...
        if (ObjectUtils.isEmpty(oldSocialUserDetails)) {
            DefaultSecurityUser defaultSecurityUser = this.register(newSocialUserDetails);
            this.binding(defaultSecurityUser.getUserId(), newSocialUserDetails);
            this.additionalRegisterOperation(defaultSecurityUser, newSocialUserDetails);
            return defaultSecurityUser;
        } else {
            DefaultSecurityUser defaultSecurityUser = this.signIn(oldSocialUserDetails);
            this.additionalSignInOperation(defaultSecurityUser, newSocialUserDetails, oldSocialUserDetails);
            return defaultSecurityUser;
        }
    }
}
