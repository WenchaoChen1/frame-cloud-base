...
import com.gstdev.cloud.commons.exception.GlobalExceptionHandler;
...
public class SecurityGlobalExceptionHandler {
    ...
    public static Result<String> resolveSecurityException(Exception exception, String path) {
        ...
        if (exception instanceof OAuth2AuthenticationException oAuth2AuthenticationException) {
            ...
            log.debug("[GstDev Cloud] |- InsufficientAuthenticationException cause content is [{}]", reason.getClass().getSimpleName());
        } else {
