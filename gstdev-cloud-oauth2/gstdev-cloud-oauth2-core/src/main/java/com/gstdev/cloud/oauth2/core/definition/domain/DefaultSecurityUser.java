...
public class DefaultSecurityUser implements UserDetails, CredentialsContainer {
     ...
     */
    public DefaultSecurityUser(String userId, String username, String password, Collection<? extends GrantedAuthority> authorities) {
     ...
     * Calls the more complex constructor with all boolean arguments set to {@code true}.
     */
    public DefaultSecurityUser(String userId, String username, String password, Collection<? extends GrantedAuthority> authorities, Set<String> roles) {
    ...
    public boolean equals(Object o) {
        ...
        DefaultSecurityUser that = (DefaultSecurityUser) o;
