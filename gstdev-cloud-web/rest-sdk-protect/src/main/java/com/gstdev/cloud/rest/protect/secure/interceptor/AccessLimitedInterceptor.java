...
//import com.gstdev.cloud.rest.core.definition.AbstractBaseHandlerInterceptor;
//import com.gstdev.cloud.rest.core.exception.FrequentRequestsException;
//import com.gstdev.cloud.rest.protect.secure.stamp.AccessLimitedStampManager;
...
//
//    log.trace("[GstDev Cloud] |- AccessLimitedInterceptor preHandle postProcess.");
//
...
//          log.warn("[GstDev Cloud] |- AccessLimited duration value is incorrect, on api [{}].", request.getRequestURI());
//        }
//      }
//
...
//        return true;
//      } else {
//        log.debug("[GstDev Cloud] |- AccessLimitedInterceptor request [{}] times.", times);
//
//        if (times <= maxTimes) {
...
//
//    log.debug("[GstDev Cloud] |- AccessLimitedInterceptor operation interval [{}] millis.", interval);
//
//    Duration duration;
