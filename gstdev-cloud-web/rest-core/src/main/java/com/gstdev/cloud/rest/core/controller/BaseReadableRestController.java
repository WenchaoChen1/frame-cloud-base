...
//public abstract class BaseReadableRestController<E extends AbstractEntity, ID extends Serializable, S extends BaseService<E, ID>> implements Controller<E, ID, S> {
//
//    @AccessLimited
