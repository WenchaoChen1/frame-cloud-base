...
//// ====================================================
//
//package com.gstdev.cloud.starter.oauth2.authentication.server.domain;
//
...
//  @JoinColumn(name = "client_id", referencedColumnName = "client_id", insertable = false, updatable = false)
//  @ToString.Exclude
//  private Set<OAuth2PostLogoutRedirectUri> postLogoutRedirectUris;
//  @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, orphanRemoval = true)
//  @JoinColumn(name = "client_id", referencedColumnName = "client_id", insertable = false, updatable = false)
//  @ToString.Exclude
...
//    Set<OAuth2PostLogoutRedirectUri> oAuth2PostLogoutRedirectUris = postLogoutRedirectUris == null ? Collections.emptySet() : postLogoutRedirectUris;
//
...
//        .collect(Collectors.toSet())))
//      .postLogoutRedirectUris(postLogoutRedirectUriSet -> postLogoutRedirectUriSet.addAll(oAuth2PostLogoutRedirectUris.stream()
//        .map(OAuth2PostLogoutRedirectUri::getPostLogoutRedirectUri)
//        .collect(Collectors.toSet())))
...
//      .collect(Collectors.toSet()));
//
//    oAuth2Client.setPostLogoutRedirectUris(registeredClient.getPostLogoutRedirectUris().stream()
//      .map(postLogoutRedirectUri -> {
//        OAuth2PostLogoutRedirectUri uri = new OAuth2PostLogoutRedirectUri();
//        uri.setClientId(clientId);
//        uri.setPostLogoutRedirectUri(postLogoutRedirectUri);
//        return uri;
//      })
//      .collect(Collectors.toSet()));
...
//    OAuth2RegisteredClient OAuth2Client = (OAuth2RegisteredClient) o;
